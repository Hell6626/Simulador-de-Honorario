        ...
        <form onSubmit={handleSearch} className="flex-1 max-w-md">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-custom-blue focus:border-transparent"
            />
          </div>
        </form>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <div className="flex items-center justify-end space-x-2">
                        <button
                          ...
                          className="text-custom-blue hover:text-custom-blue-light p-1"
                          title="Visualizar"
                        >
      ...
      >
        ...
        <div className="flex justify-end space-x-3 mt-6">
          ...
          <button
            ...
            disabled={loading}
            className="px-4 py-2 bg-custom-blue text-white rounded-lg hover:bg-custom-blue-light transition-colors disabled:opacity-50"
          >
